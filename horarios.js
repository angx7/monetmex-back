...
//     // 1. Obtener los datos de las tablas 'clases' y 'clase_horarios'
...
// insertar horarios para el año completo, por lotes
// require('dotenv').config(); // Importa y configura dotenv
// const mysql = require('mysql2/promise'); // Importa mysql2 con soporte de promesas
...
//     // 2. Generar e insertar horarios en lotes
//     let batch = [];
...
//         // Insertar cuando el lote alcanza el tamaño definido
...
//             [batch]
//           );
//           console.log(`Lote de ${batchSize} filas insertado.`);
//           batch = []; // Reinicia el lote
//         }
//       }
//     }

//     // Insertar filas restantes del último lote
//     if (batch.length > 0) {
//       await connection.query(
//         `INSERT INTO horarios (claseId, diaSemana, fecha, horaInicio, horaFin, lugaresDisponibles)
//          VALUES ?`,
//         [batch]
//       );
//       console.log(`Lote final de ${batch.length} filas insertado.`);
//     }
